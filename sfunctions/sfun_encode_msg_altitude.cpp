/*
DO NOT EDIT.
This file was automatically created by the Matlab function 'create_sfun_encode' on 07-Aug-2020 10:58:47
as part of Simulink MAVLink library.
*/
#define S_FUNCTION_NAME  sfun_encode_msg_altitude
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    DTypeId BusType;
	ssRegisterTypeFromNamedObject(S, BUS_NAME_ALTITUDE, &BusType);
	...
	ssSetOutputPortWidth(S, 0, ENCODED_LEN_ALTITUDE);
...
{
	int_T *busInfo = (int_T *) malloc(2*NFIELDS_BUS_ALTITUDE*sizeof(int_T));
    if(busInfo == NULL) {
      ssSetErrorStatus(S, "Memory allocation failure");
      return;
    }
	encode_businfo_altitude(S, busInfo, 0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	encode_vector_altitude(uvec, busInfo, yvec, 0);
}
