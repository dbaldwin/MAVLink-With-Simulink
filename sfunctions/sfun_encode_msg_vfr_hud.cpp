/*
DO NOT EDIT.
This file was automatically created by the Matlab function 'create_sfun_encode' on 07-Aug-2020 10:58:50
as part of Simulink MAVLink library.
*/
#define S_FUNCTION_NAME  sfun_encode_msg_vfr_hud
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    DTypeId BusType;
	ssRegisterTypeFromNamedObject(S, BUS_NAME_VFR_HUD, &BusType);
	...
	ssSetOutputPortWidth(S, 0, ENCODED_LEN_VFR_HUD);
...
{
	int_T *busInfo = (int_T *) malloc(2*NFIELDS_BUS_VFR_HUD*sizeof(int_T));
    if(busInfo == NULL) {
      ssSetErrorStatus(S, "Memory allocation failure");
      return;
    }
	encode_businfo_vfr_hud(S, busInfo, 0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	encode_vector_vfr_hud(uvec, busInfo, yvec, 0);
}
